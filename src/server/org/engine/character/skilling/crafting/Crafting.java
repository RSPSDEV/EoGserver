...
public class Crafting {
	...
	public enum GemCrafting {
		...
		SAPPHIRE(1623, 1694, 888, 1, 50),
		EMERALD(1621, 1696, 889, 27, 68),
		RUBY(1619, 1698, 887, 34, 85),
		DIAMOND(1617, 1700, 890, 43, 108),
		DRAGONSTONE(1631, 1702, 890, 55, 138),
		ONYX(6571, 6581, 2717, 67, 168);
