...
import server.org.engine.item.Item;
...
public abstract class Player {
	...
	public boolean isFiremaking = false, isSpinning = false, isCrafting = false;;
	...
	public int
    fletchType = -1,fletchDelay = -1,fletchAmount = -1,arrowShaft = 52,
    headlessArrows = 53,feather = 314,bowString = 1777,cBowString = 9438;
public String
    fletchThis = "";
	...
	public int doAmount;
	public int rareDrops = 0;
	public int normalDrops = 0;
	public boolean	
	...
	isUsingSpecial, isfishing = false, attemptingfish = false, isNpc = false,
	initialized = false, disconnected = false, ruleAgreeButton = false,
	RebuildNPCList = false, isActive = false, isKicked = false, isSkulled = false,
	friendUpdate = false, newPlayer = false, hasMultiSign = false, saveCharacter = false,
	mouseButton = false, splitChat = false, chatEffects = true, acceptAid = false,
	nextDialogue = false, autocasting = false, usedSpecial = false, mageFollow = false,
	dbowSpec = false, craftingLeather = false, properLogout = false, secDbow = false,
	maxNextHit = false, ssSpec = false, vengOn = false, addStarter = false,
	accountFlagged = false, msbSpec = false, caPlayerTalk1 = false, inDt = false,
	inHfd = false, disableAttEvt = false, AttackEventRunning = false,
	...
	public int 
	lastLoginDate = 0, pTime, npcId2 = 0, woodcuttingTree, saveDelay,
	ag1, ag2, ag3, ag4, ag5, ag6, playerKilled, pkPoints, totalPlayerDamageDealt,
	killedBy, lastChatId = 1, privateChat, friendSlot = 0, dialogueId, randomCoffin, 
	newLocation, specEffect, specBarId, runecraftingLevelReq, attackLevelReq, 
	defenceLevelReq, strengthLevelReq, rangeLevelReq, magicLevelReq, followId, 
	skullTimer, votingPoints, nextChat = 0, talkingNpc = -1, dialogueAction = 0,
	autocastId, followDistance, followId2, barrageCount = 0, delayedDamage = 0,
	delayedDamage2 = 0, pcPoints = 0, magePoints = 0, lastArrowUsed = -1,
	clanId = -1, autoRet = 0, pcDamage = 0, xInterfaceId = 0, xRemoveId = 0,
	xRemoveSlot = 0, tzhaarToKill = 0, tzhaarKilled = 0, waveId, frozenBy = 0,
	poisonDamage = 0, teleAction = 0, bonusAttack = 0, lastNpcAttacked = 0,
	killCount = 0, actionTimer, height = 0,  rfdRound = 0, roundNpc = 0,
	desertTreasure = 0, horrorFromDeep = 0;
	...
	public double runningEnergy = 100;
	/*
	 * Demon Slayer
	 */
