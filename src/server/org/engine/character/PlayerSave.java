		...
		while(EndOfFile == false && line != null) {
			...
			if (spot > -1) {
				...
				case 2:
					if (token.equals("character-height")) {
					...
					} else if (token.equals("DragonSlayer")) {
						p.dragonSlayer = Integer.parseInt(token2);
					} else if (token.equals("membership")) {
						p.membership = Boolean.parseBoolean(token2);
					}	else if (token.equals("cooksAssistant")) {
						...
						p.runningEnergy = Integer.parseInt(token2);
						...
						p.dorics = Integer.parseInt(token2);
					...
					} else if (token.equals("DharoksHelm")) {
						p.dhelm = Integer.parseInt(token2);					
					} else if (token.equals("DharoksAxe")) {
						p.dhaxe = Integer.parseInt(token2);					
					} else if (token.equals("DharoksBody")) {
						p.dhbody = Integer.parseInt(token2);					
					}  else if (token.equals("DharoksLegs")) {
						p.dhlegs = Integer.parseInt(token2);					
	...
	**/
	public static boolean saveGame(Client p) {
		...
		try {
			...
			characterfile.write(Integer.toString((int)p.runningEnergy), 0, Integer.toString((int)p.runningEnergy).length());
			characterfile.newLine();
			...
			characterfile.newLine();
			characterfile.write("DragonSlayer = ", 0, 15);
			characterfile.write(Integer.toString(p.dragonSlayer), 0, Integer.toString(p.dragonSlayer).length());
			characterfile.newLine();
			characterfile.write("cooksAssistant = ", 0, 17);
			characterfile.write(Integer.toString(p.cookAss), 0, Integer.toString(p.cookAss).length());
			characterfile.newLine();
			characterfile.write("DoricsQuest = ", 0, 14);
			characterfile.write(Integer.toString(p.dorics), 0, Integer.toString(p.dorics).length());
			characterfile.newLine();
			characterfile.newLine();
			characterfile.write("[DEGRADING]", 0, 11);
			characterfile.newLine();
			characterfile.write("DharoksHelm = ", 0, 14);
			characterfile.write(Integer.toString(p.dhelm), 0, Integer.toString(p.dhelm).length());
			characterfile.newLine();
			characterfile.write("DharoksAxe = ", 0, 13);
			characterfile.write(Integer.toString(p.dhaxe), 0, Integer.toString(p.dhaxe).length());
			characterfile.newLine();
			characterfile.write("DharoksBody = ", 0, 14);
			characterfile.write(Integer.toString(p.dhbody), 0, Integer.toString(p.dhbody).length());
			characterfile.newLine();
			characterfile.write("DharoksLegs = ", 0, 14);
			characterfile.write(Integer.toString(p.dhlegs), 0, Integer.toString(p.dhlegs).length());
			characterfile.newLine();
			characterfile.newLine();
			characterfile.newLine();
			/*EQUIPMENT*/
